...
a=d.dom.id("JxAudioObject")||window.JxAudioObject||document.JxAudioObject}else a=c}return a}}(),n=function(){var a=0;return function(){return a++}}();switch(function(){return window.Audio&&(new Audio).canPlayType("audio/mpeg")?i.NATIVE:d.browser.plugins.flash>=9?i.FLASH:window.ActiveXObject&&function(){try{new ActiveXObject("WMPlayer.OCX.7")}catch(a){return false}return true}()?i.WMP:i.NONE}()){case i.NATIVE:var k=d.Class({extend:e},{init:function(a){a=a||{};(this._el=new Audio).loop=Boolean(a.loop);
a.src&&this.play(a.src)},play:function(a){if(a)this._el.src=a;this._el.paused&&this._el.play()},pause:function(){this._el.pause()},stop:function(){this._el.duration=Infinity},getVolume:function(){return!this._el.muted&&this._el.volume||0},setVolume:function(a){if(isFinite(a)){this._el.volume=Math.max(0,Math.min(a,1));this._el.muted=false}},getLoop:function(){return this._el.loop},setLoop:function(a){this._el.loop=a!==false},getMute:function(){return this._el.muted},setMute:function(a){this._el.muted=
a!==false},getPosition:function(){return this._el.currentTime},setPosition:function(a){if(!isNaN(a))this._el.currentTime=Math.max(0,a)},getBuffered:function(){return this._el.buffered.length&&this._el.buffered.end(0)||0},getDuration:function(){return this._el.duration},free:function(){this._el.pause();this._el=null},on:function(a,b){this._el.addEventListener(a,b,false)},off:function(a,b){this._el.removeEventListener(a,b,false)}});if(d.platform.iPad||d.platform.iPhone){var j=[],l=function(){var a=
j.length;j.pop().off("ended",l);a>=2&&k.prototype.play.call(j[a-2])};d.Audio=d.Class({extend:k},{init:function(a){k.prototype.init.call(this,a)},play:function(a){var b=j.length;if(b&&j[b-1]!==this){b=d.array.indexOf(j,this);-1!==b?j.splice(b,1):this.on("ended",l)}j.push(this);k.prototype.play.call(this,a)},pause:function(){for(var a=0,b=j.length;a<b;a++)j[a].off("ended",l);j=[];k.prototype.pause.call(this)}})}else d.Audio=k;break;case i.FLASH:var p=function(){var a=0,b=[],c=false,g=function(){++a;
var h=f();if(h.audioLoad&&typeof h.audioLoad==="function"){c=true;h=0;for(var m=b.length;h<m;h++)b[h]._sync();b=null}else a<3E4&&setTimeout(g,100)};return function(h){if(c)h._sync();else{-1===d.array.indexOf(b,h)&&b.push(h);a===0&&g()}}}(),o;(function(){var a=[];window.Jx.AudioEventDispatcher=function(b,c,g){b=a[b];var h;b&&b._handler&&(h=b._handler[c]);c=0;for(var m=h&&h.length;c<m;c++)h[c].call(b,g)};o=function(b){a[b._seq]=b}})();d.Audio=d.Class({init:function(a){this._seq=n();this._volume=1;this._muted=
false;a=a||{};this._loop=Boolean(a.loop);this._paused=true;f(i.FLASH);a.src&&this.play(a.src)},play:function(a){var b=f();if(a){this._src=a;this._paused=false;b.audioLoad?this._sync():p(this)}else{this._paused=false;b.audioPlay&&b.audioPlay(this._seq)}},pause:function(){var a=f();this._paused=true;a.audioPause&&a.audioPause(this._seq)},stop:function(){this._paused=true;var a=f();a.audioStop&&a.audioStop(this._seq)},getVolume:function(){return!this._muted&&this._volume||0},setVolume:function(a){if(isFinite(a)){this._volume=
Math.max(0,Math.min(a,1));this._muted=false;a=f();a.audioSetVolume&&a.audioSetVolume(this._seq,this._volume)}},getLoop:function(){return this._loop},setLoop:function(a){this._loop=a!==false;a=f();a.audioSetLoop&&a.audioSetLoop(this._loop)},getMute:function(){return this._muted},setMute:function(a){this._muted=a!==false;a=f();a.audioSetVolume&&a.audioSetVolume(this._seq,this.getVolume())},getPosition:function(){var a=f();return a.audioGetPosition&&a.audioGetPosition(this._seq)/1E3||0},setPosition:function(a){isNaN(a)||
f().audioSetPosition(this._seq,Math.max(0,a)*1E3)},getBuffered:function(){var a=f();return a.audioGetBuffered&&a.audioGetBuffered(this._seq)/1E3||0},getDuration:function(){var a=f();return a.audioGetDuration&&a.audioGetDuration(this._seq)/1E3||0},free:function(){this._paused=true;var a=f();a.audioFree&&a.audioFree(this._seq)},on:function(a,b){if(!this._handler){this._handler={};o(this)}if(!this._handler[a]||!this._handler[a].length){this._handler[a]=[b];b=f();b.audioOn&&b.audioOn(this._seq,a)}else-1===
d.array.indexOf(this._handler[a],b)&&this._handler[a].push(b)},off:function(a,b){var c;if(this._handler&&this._handler[a]&&-1!==(c=d.array.indexOf(this._handler[a],b))){this._handler[a].splice(c,1);if(!this._handler[a].length){b=f();b.audioOff&&b.audioOff(this._seq,a);delete this._handler[a]}}},_sync:function(){if(this._src){var a=f(),b=this._seq;a.audioLoad(b,this._src);var c=this.getVolume();c!=1&&a.audioSetVolume(b,c);this._loop&&a.audioSetLoop(b,true);for(var g in this._handler)a.audioOn(b,g);
this._paused||a.audioPlay(b)}}});break;case i.WMP:d.Audio=d.Class({extend:e},{init:function(a){this._seq=n();a=a||{};var b=document.createElement("div");f(i.WMP).appendChild(b);b.innerHTML='<object id="WMPObject'+this._seq+'" classid="CLSID:6BF52A52-394A-11D3-B153-00C04F79FAA6" standby="" type="application/x-oleobject" width="0" height="0">                        <param name="AutoStart" value="true"><param name="ShowControls" value="0"><param name="uiMode" value="none"></object>';this._el=d.dom.id("WMPObject"+
this._seq)||window["WMPObject"+this._seq];a.loop&&this._el.settings.setMode("loop",true);a.src&&this.play(a.src)},play:function(a){if(a){var b=document.createElement("a");b.href=a;d.dom.getHref(b);this._canPlayThroughFired=this._isBuffering=this._isPlaying=false;this._el.URL=d.dom.getHref(b)}this._el.playState!==3&&this._el.controls.play();this._hasPoll()&&this._startPoll()},pause:function(){this._el.controls.pause()},stop:function(){this._el.controls.stop()},getVolume:function(){return!this._el.settings.mute&&
